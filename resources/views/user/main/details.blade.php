    ...
    <div class="container-fluid pb-5">
        <div class="row px-xl-5">
            <div class="col-lg-5 mb-30">
                <a href="{{ route('user#home') }}" class="text-black fs-5 text-decoration-none">
            ...
            <div class="col-lg-7 h-auto mb-30 mt-3">
                <div class="h-100 bg-light p-30">
                    ...
                    <div class="d-flex mb-3">
                        ...
                        <small class="pt-1">{{ $data->view_count+1 }}<i class="fa-solid fa-eye ms-1"></i> </small>
                    </div>
                    ...
                    <div class="d-flex align-items-center mb-4 pt-2">
                        <div class="input-group quantity mr-3" style="width: 130px;">
                            ...
                            <input type="text" class="form-control bg-secondary border-0 text-center" id="addCount" value="1">
                            <div class="input-group-btn">
                        ...
                        <button class="btn btn-primary px-3" id="addToCartBtn"><i class="fa fa-shopping-cart mr-1"></i> Add To
                            Cart</button>
                    </div>
...
<script>
    $(document).ready(function(){
        ...
        $.ajax({
            type:'get',
            url:'http://127.0.0.1:8000/user/ajax/user/viewCount',
